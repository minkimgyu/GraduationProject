...
{
    //public class MovementComponent : MonoBehaviour //: DisplacementSender
    //{
    ...
    //    public float SendMoveDisplacement() { return _rigidbody.velocity.magnitude * _velocityLengthDecreaseRatio; }
    ...
    //        //_rigidbody.velocity = _moveDirection * moveForce * Time.fixedDeltaTime;
