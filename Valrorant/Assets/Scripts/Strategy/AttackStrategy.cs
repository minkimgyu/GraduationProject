...
abstract public class AttackStrategy
{
...
public class NoAttack : AttackStrategy
{
    public override void Attack() { }
}


abstract public class ApplyAttack : AttackStrategy
{
...
abstract public class BaseGunAttack : ApplyAttack
{
    ...
    protected List<PenetrateData> ReturnPenetrateData(Vector3 offset = default(Vector3))
    {
        ...
        RaycastHit[] tmpHits;
        tmpHits = Physics.RaycastAll(endPoint, -_camTransform.forward, _range, _targetLayer); // 다시 반대로 쏴줌
...
public class ScatterProjectileGunAttack : BaseGunAttack
{
    ...
    List<Vector3> ReturnOffsetDistance()
    {
        ...
        for (int i = 0; i < _projectileCounts; i++)
        {
            ...
            offsetDistance.Add(new Vector3(x, y, 0));
        }
