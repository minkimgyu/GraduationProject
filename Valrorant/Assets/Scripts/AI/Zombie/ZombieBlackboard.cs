...
public struct ZombieBlackboard
{
    ...
    public Action<SoundType, bool> PlaySFX { get; }
    ...
    public ZombieBlackboard(float attackDamage, float angleOffset, float angleChangeAmount, int wanderOffset, float stateChangeDelay, 
        ...
        Action ClearAllNoise, Func<bool> IsQueueEmpty, Func<Vector3> ReturnFrontNoise,
        ...
        Func<ISightTarget> ReturnTargetInSight, Action<SoundType, bool> PlaySFX)
    {
