...
public class Bucky : Gun
{
    public override void Initialize(BuckyData data, RecoilRangeData mainRangeData, RecoilRangeData subRangeData)
    {
        ...
        _reloadStrategy = new RoundByRoundReload(data.weaponName, data.reloadBeforeDuration, data.reloadFinishDuration, data.reloadExitDuration, data.maxAmmoCountInMagazine, OnPlayWeaponAnimation, OnReloadRequested);
    }
}