...
* FSM을 활용한 Player 제작
  ...
  이동, 자세, 상호작용, 무기 사용 기능을 구현하기 위해 각각의 기능을 독립시켜 복잡도를 낮추기 위해 Concurrent State Machine을 적용해봤습니다. 또한 이동 기능 구현 시 앞으로의 확장성을 위해 Hierachical Finite State Machine 방식을 적용해봤습니다.
